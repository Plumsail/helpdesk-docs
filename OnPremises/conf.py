...
# -*- coding: utf-8 -*-
#
# HelpDesk Documentation documentation build configuration file, created by
...
html_theme_options = {
    ...
    "project_nav_name": "HelpDesk OnPremises",
...
# The name for this set of Sphinx documents.
# "<project> v<release> documentation" by default.
#html_title = 'HelpDesk Documentation v2.0.0'
...
htmlhelp_basename = 'HelpDeskDocumentationdoc'
...
latex_documents = [
    (master_doc, 'HelpDeskDocumentation.tex', 'HelpDesk Documentation Documentation',
     'Plumsail', 'manual'),
]
...
man_pages = [
    (master_doc, 'helpdeskdocumentation', 'HelpDesk Documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HelpDeskDocumentation', 'HelpDesk Documentation Documentation',
     author, 'HelpDeskDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
